...
그럼 이와 같이 여러 basis function의 선형결합의 형태를 갖는 모형은 어떻게 학습할까? 다음과 같이 training data의 loss 총합을 최소화하는 $\beta_1,\cdots,\beta_M, \gamma_1, \cdots, \gamma_M$을 찾는 방법을 생각해 볼 수 있다.
